...
func (c *Converter) Convert(input afero.Fs, inputPath string, output afero.Fs) error {
	return afero.Walk(input, inputPath, func(inputFilePath string, info os.FileInfo, err error) error {
		if err != nil {
